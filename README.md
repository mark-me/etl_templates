...
This repository aims to implement descriptions of logical data models and descriptions of model lineage mappings to create procedures that generate data, filling those models.
